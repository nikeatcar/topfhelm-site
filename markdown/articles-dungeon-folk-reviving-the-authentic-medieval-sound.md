...
Dungeon Folk can be produced using live acoustic instruments or high-quality digital samples that mimic traditional folk sounds. The essential steps for crafting a Dungeon Folk track include:

### Choosing Instruments

* Instead of synthesizers, artists use string and wind instruments (lute, hurdy-gurdy, violin, jaw harp, bagpipes, flutes).
* Rhythmic elements include medieval drums or hand percussion (such as war drums or tambourines).
* Some musicians blend acoustic and synthetic elements, but natural, organic sound is key to Dungeon Folk.

### Composition & Structure

* Inspired by medieval ballads, minstrels, and traditional folk melodies.
* Often employs minor keys and modal scales (e.g., Dorian mode) to enhance the historical feel.
* Tracks can be melodic and danceable or dark and atmospheric, depending on the theme.

### Recording & Mixing

* Uses warm analog-style processing to achieve an old-world, vintage feel.
* Heavy use of natural reverb, simulating the acoustics of medieval halls or stone castles.

## Dungeon Folk vs. Dungeon Synth: What’s the Difference?
...
* **Nahadoth** – Incorporates accordion, adding a mystical folk flavor.

## The Future of Dungeon Folk

The Dungeon Synth community is actively discussing the evolution of Dungeon Folk. Key questions include:

* Must Dungeon Folk only use live instruments?
