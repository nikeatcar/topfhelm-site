...
exports.nodeHtmlParserConfig = exports.truthyStr = exports.getTrailingWhitespaceInfo = exports.isWhiteSpaceOnly = exports.surround = exports.trimNewLines = void 0;
...
function parseHTML(html, options) {
    ...
    if (options.preferNativeParser) {
        ...
        nodeHtmlParse = getNodeHtmlParser();
    if (!el)
        el = nodeHtmlParse(html, exports.nodeHtmlParserConfig);
    perfStop('parse');
    return el;
}
