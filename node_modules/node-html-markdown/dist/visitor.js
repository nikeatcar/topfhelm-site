...
class Visitor {
    ...
    optimizeTree(node) {
        ...
        (function visit(node) {
            let res = false;
            if ((0, nodes_1.isTextNode)(node) || ((0, nodes_1.isElementNode)(node) && config_1.contentlessElements.includes((node.tagName || '').toUpperCase()))) {
                res = true;
            }
            else {
                ...
                if (!childNodes.length) {
                    ...
                    if (typeof translator === 'function' || (translator === null || translator === void 0 ? void 0 : translator.preserveIfEmpty))
                        res = true;
                }
                else
    ...
    visitNode(node, textOnly, metadata) {
        ...
        if ((0, nodes_1.isTextNode)(node)) {
            ...
            if (node.isWhitespace && !(metadata === null || metadata === void 0 ? void 0 : metadata.preserveWhitespace)) {
            ...
            const sourceText = (metadata === null || metadata === void 0 ? void 0 : metadata.preserveWhitespace) ? node.text : node.text || node.trimmedText;
            ...
            if (!(metadata === null || metadata === void 0 ? void 0 : metadata.preserveWhitespace) && processedText) {
                if (sourceText && /^\n/.test(sourceText))
        ...
        const translatorCfgOrFactory = tagNameUpper
            ? ((metadata === null || metadata === void 0 ? void 0 : metadata.translators) ? metadata.translators[tagNameUpper] : this.instance.translators.get(node.tagName))
            : undefined;
...
function getMarkdownForHtmlNodes(instance, rootNode, fileName) {
    ...
    result = (0, utilities_1.trimNewLines)(result);
